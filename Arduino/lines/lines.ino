...
void setup() {
  ...
  while(true) {
    if((0 ? (2 == 0 ? linefollower_2.readSensors() == 0 : (linefollower_2.readSensors() & 2) == 2) : (2 == 0 ? linefollower_2.readSensors() == 3 : (linefollower_2.readSensors() & 2) == 0))){

      }
      if((linefollower_2.readSensors() <= 1.5)  &&  (linefollower_2.readSensors() >= 0.4)){
